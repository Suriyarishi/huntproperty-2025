...
const ProjectListingFlow: React.FC<ProjectListingFlowProps> = ({ onCancel }) => {
    ...
    const [residentialSubtype, setResidentialSubtype] = useState<'Apartment' | 'Plot' | null>(null); // Keeping for backward compat if needed, but focusing on projectSubtype
    ...
    const [formData, setFormData] = useState({
        ...
        projectDetails: {
            ...
            description: '',
            price: '',
            // ... add more as needed for specific flows
        },
    ...
    const nextStep = () => {
        ...
        // Validation for Step 4: Category Selection
        if (currentStep === 4) {
            if (!projectCategory) {
        ...
        return (
            <div className="min-h-[600px] flex flex-col items-center justify-center space-y-12 py-20 animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full max-w-xl">
                    ...
                    <button 
                        className="flex-1 h-18 bg-[#2FED9A] text-[#1a1c21] rounded-[24px] font-black uppercase tracking-widest text-xs hover:scale-105 transition-all shadow-xl py-6"
                    >
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="flex-1 space-y-12">
                                ...
                                <div className="min-h-[500px]">
                                    ...
                                    {/* STEP 2: Builder RERA Validation */}
                                    {currentStep === 2 && (
                                            ...
                                            {formData.hasBuilderRera === true && (
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-gray-50/50 p-8 rounded-[32px] border border-gray-100 animate-fade-in-up">
                                                    <div className="space-y-2">
                                                        ...
                                                        <select 
                                                            className="w-full h-14 bg-white border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm appearance-none"
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="relative group">
                                                            ...
                                                            <div className="w-full h-14 bg-white border-2 border-dashed border-gray-100 rounded-xl flex items-center justify-center gap-2 text-gray-400 group-hover:border-[#2FED9A] group-hover:text-[#2FED9A] transition-all">
                                                                <Upload size={16} />
                                                ...
                                                <div className="space-y-8 animate-fade-in-up">
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-gray-50/50 p-8 rounded-[32px] border border-gray-100">
                                                        ...
                                                        <div className="md:col-span-2 space-y-2">
                                                            ...
                                                            <div className="relative group">
                                                                <input type="file" className="absolute inset-0 opacity-0 cursor-pointer z-10" onChange={(e) => handleFileUpload('incorporationCert', e.target.files?.[0] || null)} />
                                                                <div className="w-full h-32 bg-white border-4 border-dashed border-gray-100 rounded-[24px] flex flex-col items-center justify-center gap-3 text-gray-400 group-hover:border-[#2FED9A] group-hover:text-[#2FED9A] transition-all">
                                                    ...
                                                    <div className="bg-[#1a1c21] text-white p-10 rounded-[40px] space-y-6 shadow-2xl">
                                                        <div className="space-y-2">
                                                            <h4 className="text-xl font-black uppercase tracking-tight text-[#2FED9A]">Consent Declaration</h4>
                                                        ...
                                                        <label className="flex items-center gap-4 cursor-pointer pt-4 group">
                                                            ...
                                                            />
                                                            <div className={`w-8 h-8 rounded-xl border-2 flex items-center justify-center transition-all ${formData.acceptedTerms ? 'bg-[#2FED9A] border-[#2FED9A] text-[#1a1c21]' : 'border-gray-700'}`}>
                                                                {formData.acceptedTerms && <Check size={16} strokeWidth={4} />}
                                                            </div>
                                                            <span className="text-sm font-bold uppercase tracking-tight group-hover:text-[#2FED9A] transition-colors">I accept the Terms & Conditions</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <div className={`h-14 px-6 rounded-xl border-2 border-dashed flex items-center justify-center gap-2 transition-all ${formData.authPanFile ? 'border-teal-500 bg-teal-50 text-teal-600' : 'border-gray-100 text-gray-400 hover:border-[#2FED9A]'}`}>
                                                            <Upload size={16} />
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <div className={`h-14 px-6 rounded-xl border-2 border-dashed flex items-center justify-center gap-2 transition-all ${formData.authAadhaarFile ? 'border-teal-500 bg-teal-50 text-teal-600' : 'border-gray-100 text-gray-400 hover:border-[#2FED9A]'}`}>
                                                            <Upload size={16} />
                                    ...
                                    {/* STEP 4: Select Project Category */}
                                    {currentStep === 4 && (
                                                    ...
                                                    {[
                                                        ...
                                                        <button
                                                            ...
                                                            className={`group p-8 rounded-[32px] transition-all duration-300 relative flex flex-col items-center gap-5 border bg-white/50 backdrop-blur-sm ${
                                                                ...
                                                                ? 'border-[#2FED9A] ring-4 ring-[#2FED9A]/5 shadow-xl shadow-teal-500/5' 
                                                                : 'border-gray-200 hover:border-[#2FED9A]/30 shadow-sm hover:shadow-md'
                                                            }`}
                                                        >
                                                            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center transition-all ${
                                                                projectCategory === cat.id 
                                                                ? 'bg-[#2FED9A] text-[#1a1c21]' 
                                                                : 'bg-gray-50 text-gray-600 group-hover:bg-gray-100 group-hover:text-[#2FED9A]'
                                                            }`}>
                                                            ...
                                                            {projectCategory === cat.id && (
                                                                <div className="absolute top-4 right-4 text-[#2FED9A]">
                                                                    <div className="w-5 h-5 bg-[#2FED9A] rounded-full flex items-center justify-center text-[#1a1c21]">
                                                ...
                                                {projectCategory && (
                                                    <div className="w-full space-y-10 pt-16 animate-fade-in-up border-t border-gray-50/50 px-4">
                                                        <div className="text-center space-y-3">
                                                            ...
                                                            <div className="w-12 h-1 bg-[#2FED9A] mx-auto rounded-full opacity-50" />
                                                        </div>
                                                            ...
                                                            {(projectCategory === 'Residential' 
                                                                ...
                                                                <button
                                                                    ...
                                                                    className={`px-4 py-5 rounded-2xl border transition-all duration-200 flex flex-col items-center gap-4 text-center group relative ${
                                                                        projectSubtype === sub
                                                                        ? 'bg-[#1a1c21] border-[#2FED9A] text-white shadow-lg'
                                                                        : 'bg-white border-gray-200 text-gray-500 hover:border-[#2FED9A]/30 hover:bg-gray-50/50'
                                                                    }`}
                                                                >
                                                                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${
                                                                        projectSubtype === sub 
                                                                        ? 'bg-[#2FED9A] text-[#1a1c21]' 
                                                                        : 'bg-gray-50 text-[#2FED9A] opacity-60 group-hover:opacity-100 group-hover:bg-gray-100'
                                                                    }`}>
                                                                    ...
                                                                    {projectSubtype === sub && (
                                                                        <div className="absolute top-2 right-2">
                                                                            <div className="w-3 h-3 bg-[#2FED9A] rounded-full flex items-center justify-center text-[#1a1c21]">
                                    ...
                                    {/* STEP 5: Conditional Flow Handling */}
                                    {currentStep === 5 && (
                                        <div className="space-y-12 animate-fade-in">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                ...
                                                {projectCategory === 'Commercial' && (
                                                    <div className="space-y-2">
                                                        ...
                                                        <input type="text" placeholder="Start - End" className="w-full h-14 bg-gray-50 border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm" />
                                                    </div>
                                                )}
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="flex gap-2">
                                                                {['1BHK', '2BHK', '3BHK', '4BHK+'].map(bhk => (
                                                                    <button key={bhk} className="flex-1 h-12 bg-white border border-gray-100 rounded-xl font-bold text-[10px] uppercase hover:bg-[#2FED9A] transition-colors">{bhk}</button>
                                                                ))}
                                                            </div>
                                                        </div>
                                                        <div className="space-y-2">
                                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Total Floors</label>
                                                            <input type="number" placeholder="Number" className="w-full h-14 bg-gray-50 border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm" />
                                                        </div>
                                                    </>
                                                )}
                                                ...
                                                {projectCategory === 'Residential' && residentialSubtype === 'Plot' && (
                                                    <>
                                                        <div className="space-y-2">
                                                            ...
                                                            <input type="text" placeholder="Area" className="w-full h-14 bg-gray-50 border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm" />
                                                        </div>
                                                        <div className="space-y-2">
                                                            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Dimensions (LxW)</label>
                                                            <input type="text" placeholder="e.g. 50x30" className="w-full h-14 bg-gray-50 border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm" />
                                                        </div>
                                                    </>
                                                )}
                                                ...
                                                {projectCategory === 'Agricultural' && (
                                                    <>
                                                        <div className="space-y-2">
                                                            ...
                                                            <select className="w-full h-14 bg-gray-50 border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] appearance-none shadow-sm">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <input type="text" placeholder="Well, Canal, Borewell" className="w-full h-14 bg-gray-50 border border-gray-100 rounded-xl px-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm" />
                                                        </div>
                                                    </>
                                                )}
                                                ...
                                                <div className="md:col-span-2 space-y-2">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full bg-gray-50 border border-gray-100 rounded-xl p-6 font-bold text-sm outline-none focus:border-[#2FED9A] shadow-sm resize-none"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-12 animate-fade-in">
                                            <div className="space-y-6">
                                                ...
                                                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                                    <div className="relative aspect-square">
                                                        ...
                                                        <div className="w-full h-full border-4 border-dashed border-gray-100 rounded-[32px] flex flex-col items-center justify-center gap-2 text-gray-300 hover:border-[#2FED9A] hover:text-[#2FED9A] transition-all bg-gray-50/30 group">
                                            ...
                                            <div className="bg-[#1a1c21] p-10 rounded-[48px] border border-white/5 space-y-10 shadow-2xl relative overflow-hidden">
                                                ...
                                                <div className="flex items-center justify-between relative z-10">
                                                    ...
                                                    <div className="px-6 py-2 bg-[#2FED9A] text-[#1a1c21] rounded-full font-black text-[10px] uppercase tracking-widest flex items-center gap-2">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                                                    <div className="space-y-6">
                                                        <div className="flex items-center gap-3 text-[#2FED9A]">
                                                            <Building2 size={24} />
                                                            <span className="text-[10px] font-black uppercase tracking-widest text-[#2FED9A]">Entity Details</span>
                                                        </div>
                                                        <div className="space-y-2">
                                                    ...
                                                    <div className="space-y-6">
                                                        <div className="flex items-center gap-3 text-[#2FED9A]">
                                                            <Navigation size={24} />
                                                            <span className="text-[10px] font-black uppercase tracking-widest text-[#2FED9A]">Project Scope</span>
                                                        </div>
                                                        <div className="space-y-2">
                                                    ...
                                                    <div className="space-y-6">
                                                        <div className="flex items-center gap-3 text-[#2FED9A]">
                                                            <User size={24} />
                                                            <span className="text-[10px] font-black uppercase tracking-widest text-[#2FED9A]">Primary Liaison</span>
                                                        </div>
                                                        <div className="space-y-2">
                                ...
                                <div className="flex items-center justify-between pt-12 border-t border-gray-50">
                                    ...
                                    <div className="flex gap-6">
                                        ...
                                        <button
                                            ...
                                            className="px-12 py-5 bg-[#2FED9A] text-[#1a1c21] rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-xl shadow-teal-500/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-3"
                                        >
