...
const AddFPP: React.FC<AddFPPProps> = ({ formData, updateFormData }) => {
    const setFormData = (data: any) => updateFormData(data);
    const plan = formData.paymentPlans.find(p => p.type === 'FPP');
